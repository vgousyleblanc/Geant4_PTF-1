// ConstructMaterials
// Is basically a copy of the method from WCSim
// builds all of the elements, and materials needed for WC detectors
// Includes optical surfaces:
//
//   OpWaterBSSurface = new G4OpticalSurface("WaterBSCellSurface");
//      dielectric_dielectric, unified, groundfrontpainted, sigmaalpha=0.1
//      uses black sheet properties for reflection/absorption
//
//  
...
void OpNoviceDetectorConstruction::ConstructMaterials()
{
